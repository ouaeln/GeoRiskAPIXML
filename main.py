...
def get(addresse='searchedaddress'):
    ...
    if (len(dictionary.get('features')) <= 0):
        return jsonify({"success": False, "results": {'Address': addresse, 'Alea': None, 'Niveau_Alea': None, 'AleaLabel': None}}), 200
    ...
    if len(returneddata.get('features')) > 0:
        ...
        return jsonify({"success": True, "results":{'Address':adresse1, 'Alea':"Non",'Niveau_Alea':0, 'AleaLabel': "Exposition au retrait-gonflement des sols argileux : Non"}}), 200
